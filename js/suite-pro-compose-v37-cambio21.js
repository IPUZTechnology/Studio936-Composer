// Studio 936 Composer - Suite Pro Compose Coordinator v3.6 Cambio 21
...
`;
  ...
  function render(ctx) {
    ...
    const banner = ctx.el("div", "s936-cmp-change-banner", "Cambio número 21 · Mini consola izquierda + Chart limpio");
    ...
    try {
      ...
      console.error("Suite Pro Compose Cambio 21 render error:", error);
      const box = ctx.el("section", "s936-cmp-render-error");
      box.innerHTML = "<b>Cambio número 21 · Estructura no pudo renderizar.</b><br>El error queda visible en pantalla. Revisa la primera línea roja de consola.";
