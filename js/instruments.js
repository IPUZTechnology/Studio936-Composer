...
window.Studio936Instruments = {
    ...
    // Cambio 456: guitarras nuevas pedidas por Val — cuerdas de metal y
    // eléctrica. Estos parametros solo se usan como respaldo si el
    // sample real todavia no cargo.
    guitarSteel:{label:'Guitarra (cuerdas)', mode:'pluck', body:150, brightness:2100, pick:1.0, chord:{type:'triangle', type2:'sine', filter:2000, attack:.006, decayMult:.68, detune:1.002}, bass:{type:'triangle', type2:'sine', filter:1000, attack:.006, decayMult:.8, detune:1.0016}, solo:{type:'triangle', type2:'sine', filter:2400, attack:.005, decayMult:.75, detune:1.0025}, strum:.022},
    guitarElectric:{label:'Guitarra Eléctrica', mode:'pluck', body:120, brightness:2600, pick:.7, chord:{type:'sine', type2:'triangle', filter:2200, attack:.01, decayMult:1.1, detune:1.002}, bass:{type:'sine', type2:'triangle', filter:1100, attack:.01, decayMult:1.2, detune:1.0015}, solo:{type:'sine', type2:'triangle', filter:2600, attack:.008, decayMult:1.15, detune:1.003}, strum:.02},
    ...
    // Cambio 454: Banjo — instrumento nuevo, sample real via WebAudioFont
    // (webaudiofont-engine.js). Estos parametros solo se usan como
    // respaldo si el sample todavia no cargo.
    banjo:{label:'Banjo', mode:'pluck', body:310, brightness:3400, pick:1.05, chord:{type:'triangle', type2:'sine', filter:3000, attack:.003, decayMult:.4, detune:1.005}, bass:{type:'triangle', type2:'sine', filter:1600, attack:.003, decayMult:.46, detune:1.003}, solo:{type:'triangle', type2:'sine', filter:3400, attack:.003, decayMult:.42, detune:1.006}, strum:.016},
