...
window.Studio936Instruments = {
    ...
    guitar:{label:'Guitarra', mode:'pluck', body:165, brightness:1850, pick:.95, chord:{type:'triangle', type2:'sine', filter:1800, attack:.006, decayMult:.68, detune:1.003}, bass:{type:'triangle', type2:'sine', filter:900, attack:.006, decayMult:.82, detune:1.002}, solo:{type:'triangle', type2:'sine', filter:2200, attack:.005, decayMult:.74, detune:1.004}, strum:.028},
    ukulele:{label:'Ukelele', mode:'pluck', body:470, brightness:3000, pick:1.15, chord:{type:'triangle', type2:'sine', filter:3200, attack:.004, decayMult:.45, detune:1.006, transpose:12}, bass:{type:'triangle', type2:'sine', filter:1700, attack:.004, decayMult:.5, detune:1.004, transpose:12}, solo:{type:'triangle', type2:'sine', filter:3600, attack:.003, decayMult:.52, detune:1.006, transpose:12}, strum:.02},
