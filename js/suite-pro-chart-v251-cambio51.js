// Studio 936 Composer - Chart View v2.5.1 Cambio 51 (LYRICS KARAOKE RIBBON)
...
// Cambio 51: letra en cinta fluida (sin cuadrícula), resaltado de la palabra activa
// sincronizado con el mismo beat que ya ilumina el acorde. No agrega audio nuevo.
window.Studio936SuiteProChart = (() => {
  "use strict";
  const VERSION = "chart-v2.5.1-cambio-51";
  const STYLE_ID = "s936-chart-v251-cambio51";
...
`;
  ...
  function syncActiveLyricWord(sectionKey, barIndex, beatIndex) {
    ...
    const selector = `.s936-ch-lyric-beat[data-section="${sectionKey}"][data-bar="${barIndex}"][data-beat="${beatIndex}"]`;
