// Studio 936 Composer - Chart View v2.5.3 Cambio 71 (VERSION BADGE VISIBLE)
...
// Cambio 71: se agrega "CHART CAMBIO 71" visible en el encabezado del Chart
// (junto a estilo/BPM/compases), para poder confirmar de un vistazo qué
// versión del Chart está realmente corriendo, sin depender de DevTools —
// mismo objetivo que el badge ya agregado en Ly Letra (Cambio 63).
window.Studio936SuiteProChart = (() => {
  "use strict";
  const VERSION = "chart-v2.5.3-cambio-71";
  const STYLE_ID = "s936-chart-v253-cambio71";
...
`;
  ...
  function render({ container, instrument, onChordEdit } = {}) {
    ...
    metaEl.textContent = (edState.style || "") + (edState.bpm ? " · " + edState.bpm + " BPM" : "") + " · " + totalBars + " comp. · CHART CAMBIO 71";
