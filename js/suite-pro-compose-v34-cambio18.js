// Studio 936 Composer - Suite Pro Compose Coordinator v3.3 Cambio 17
...
`;
  ...
  function render(ctx) {
    ...
    const banner = ctx.el("div", "s936-cmp-change-banner", "Cambio número 18 · Main controla instrumento + Chart alto");
