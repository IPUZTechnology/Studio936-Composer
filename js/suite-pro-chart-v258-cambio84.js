// Studio 936 Composer - Chart View v2.5.8 Cambio 84 (KARAOKE MÁS GRANDE, CON WRAP SEGURO)
...
// Cambio 84: se sube el tamaño de la letra karaoke (1.42rem → 1.6rem) ahora
// que es seguro hacerlo — si una palabra no cabe en su tiempo (ej. 4
// sílabas), hace wrap dentro de su PROPIA columna en vez de invadir la
// celda vecina (antes podía "pasarse" al tiempo de al lado).
window.Studio936SuiteProChart = (() => {
  "use strict";
  const VERSION = "chart-v2.5.8-cambio-84";
  const STYLE_ID = "s936-chart-v258-cambio84";
...
`;
  ...
  function render({ container, instrument, onChordEdit } = {}) {
    ...
    metaEl.textContent = (edState.style || "") + (edState.bpm ? " · " + edState.bpm + " BPM" : "") + " · " + totalBars + " comp. · CHART CAMBIO 84";
