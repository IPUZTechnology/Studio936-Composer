// Studio 936 Composer - Suite Pro Structure / ADN Module v4.7.7 Cambio 75
...
// Cambio 75: corrección de rumbo respecto al Cambio 74 — se RESTAURAN los
// íconos de arriba "💾 Guardar" y "⇢ Mover al tablero" (funcionando, con
// confirmación clara), y se ELIMINA la barra de abajo ("✓ Guardar y ver en
// Chart" + "Cerrar"), que quedaba redundante — el cierre ya lo cubre el ✕
...
(function () {
  ...
  const MODULE_CAMBIO_LABEL = "Cambio 75";

  const STYLE_ID = "s936SuiteProStructureStylesV477Cambio75";
