// Studio 936 Composer - Suite Pro Structure / ADN Module v4.4.6 Cambio 41
...
(function () {
  ...
  const STYLE_ID = "s936SuiteProStructureStylesV446Cambio41";
  ...
  function register() {
    ...
    window.Studio936SuiteProStructure = { version: "structure-v4.4.6-cambio-41", render };
  ...
  function installDockFlexGuard() {
    ...
    const sync = () => {
      try {
        ...
        if (chartPanel) {
          // Cambio 41: no empujar el Chart con margin-left; eso generaba scroll horizontal
  ...
  function installChartStageKeeperCambio41() {
    ...
    const ensure = () => {
      try {
        ...
        console.warn("Cambio 41 chart keeper:", error);
      }
    };
...
`;
    ...
    style.textContent += `
/* Cambio 41 · Dock flexible real, sin cubrir Chart ni crear scroll horizontal */
html, body{
  overflow-x:hidden!important;
}
#s936SuitePro{
    ...
    const mount = (attempt = 0) => {
      ...
      if (!Chart || typeof Chart.mountInRightPanel !== "function") {
        ...
        if (attempt < 12) {
          ...
          status.textContent = "Cambio número 37 · No encontré Studio936SuiteProChart.mountInRightPanel(). Revisa que index.html cargue suite-pro-chart-v241-cambio41.js.";
