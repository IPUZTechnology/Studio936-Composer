// Studio 936 Composer - Suite Pro Compose Coordinator v3.0 Cambio 14
...
`;
  ...
  function render(ctx) {
    ...
    const banner = ctx.el("div", "s936-cmp-change-banner", "Cambio número 14 · Main manda pulso · Chart manda armonía");
