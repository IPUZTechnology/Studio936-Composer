// Studio 936 Composer - Suite Pro Compose Coordinator v4.6 Cambio 31
...
(function () {
  ...
  const STYLE_ID = "s936SuiteProComposeStylesCambio30";
...
`;
  ...
  function render(ctx) {
    ...
    const banner = ctx.el("div", "s936-cmp-change-banner", "Cambio número 31 · Escenario alto + play superior unificado");
    ...
    try {
      ...
      box.innerHTML = "<b>Cambio número 31 · Estructura no pudo renderizar.</b><br>El error queda visible en pantalla. Revisa la primera línea roja de consola.";
