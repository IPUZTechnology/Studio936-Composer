// Studio 936 Composer - Suite Pro Compose Coordinator v2.9 Cambio 13
...
(function () {
  ...
  const STYLE_ID = "s936SuiteProComposeStylesCambio6";
...
`;
  ...
  function render(ctx) {
    ...
    const banner = ctx.el("div", "s936-cmp-change-banner", "Cambio número 13 · Practicar Chart mantiene el acorde durante el compás");
    ...
    try {
      ...
      console.error("Suite Pro Compose Cambio 6 render error:", error);
      const box = ctx.el("section", "s936-cmp-render-error");
      box.innerHTML = "<b>Cambio número 10 · Estructura no pudo renderizar.</b><br>El error queda visible en pantalla. Revisa la primera línea roja de consola.";
