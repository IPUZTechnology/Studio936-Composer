// Studio 936 Composer - Chart View v2.3.8 Cambio 38 (CONSOLA POR SECCIÓN FUNCIONAL)
...
window.Studio936SuiteProChart = (() => {
  "use strict";
  const VERSION = "chart-v2.3.8-cambio-38";
  const STYLE_ID = "s936-chart-v238-cambio38";
...
/* Cambio 38 · Escenario más alto: Chart pegado a los controles superiores. */
body.s936-chart-stage .status-bar{
  min-height:30px!important;
...
body.s936-chart-stage #s936-chart-view-panel .s936-ch-head{
