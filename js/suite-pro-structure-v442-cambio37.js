// Studio 936 Composer - Suite Pro Structure / ADN Module v4.4.2 Cambio 37
...
(function () {
  ...
  const STYLE_ID = "s936SuiteProStructureStylesV442Cambio37";
  ...
  function register() {
    ...
    window.Studio936SuiteProStructure = { version: "structure-v4.4.2-cambio-37", render };
...
/* Cambio 37 · Limpieza del dock: no trackers/banners temporales */
#s936SuitePro .s936-struct-change-banner,
#s936SuitePro .s936-struct-right-status,
#s936SuitePro .s936-ckpt-topbar,
...
/* Cambio 37 · Dock como consola por sección: menú arriba, botones sobrios y agrupados */
#s936SuitePro .s936-ckpt-topbar,
#s936SuitePro .s936-ckpt-topbar-compact,
#s936SuitePro .s936-ckpt-menu-btn-wide,
#s936SuitePro .s936-ckpt-dropdown{
...
`;
    style.textContent += `
/* Cambio 37 · Panel izquierdo autoajustado y más compacto.
...
`;
    style.textContent += `
/* Cambio 37 · Consola por sección más clara: nombre primero, botones definidos y flechas compactas */
#s936SuitePro .s936-struct-card.s936-struct-arrangement-full{
...
`;
    ...
    style.textContent += `
/* Cambio 37 · Consola por sección: botones principales más legibles y mover compacto */
#s936SuitePro .s936-struct-card.s936-struct-arrangement-full{
...
`;
  ...
  function render(ctx, shell) {
    ...
    // Cambio 37: sin banners temporales en el dock; el menú de canción vive en Compose.
    ...
    try {
      ...
      // Cambio 37: el menú de canción sube al nivel Compose; no duplicar cabecera en Estructura.
  ...
  function renderChangeBanner(ctx, root) { /* Cambio 37: tracker visual removido del dock. */ }
  ...
  function scheduleRightPanelChart(ctx, root) {
    ...
    const ensureChartScriptLoaded = () => {
      ...
      script.src = src + "?v=cambio-37-20260701";
  ...
  function partRow(ctx, s, parts, part, index) {
    ...
    // Cambio 37 · Mover sección como micro-stepper vertical para ahorrar espacio
