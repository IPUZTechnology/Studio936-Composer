// Studio 936 Composer - Suite Pro Structure / ADN Module v4.5.3 Cambio 48
...
`;
  ...
  function openSectionLyricsEditor(ctx, s, part, parts) {
    ...
    title.appendChild(ctx.el("b", "", "Ly · Editor tipo Chart"));
    ...
    const help = ctx.el("div", "s936-lyrics-help", "Réplica de la sección actual: 4 compases por línea y 4 tiempos por compás. Escribe palabra, sílaba o frase en cada tiempo; el Chart mostrará la frase completa.");
