// Studio 936 Composer - Chart View v2.2.7 Cambio 27 (ESCENARIO COMPACTO + PLAY UNIFICADO)
...
window.Studio936SuiteProChart = (() => {
  "use strict";
  const VERSION = "chart-v2.2.7-cambio-27";
  const STYLE_ID = "s936-chart-v227-cambio27";
...
.s936-ch-beat.compact-hold.active-beat .s936-ch-rhythm-mark{
  ...
  function render({ container, instrument, onChordEdit } = {}) {
    ...
    changeBanner.textContent = "Cambio número 27 · escenario compacto + play unificado";
  ...
  function bindMainTransportToChart() {
    ...
    _chartTransportCaptureHandler = (event) => {
      ...
      const ok = startChartRhythmConsole(panel, {
        withPulse: false,
        scope: "song",
        sourceLabel: btn.id === "playSongBtn" ? "Canción completa" : "Canción completa"
      });
