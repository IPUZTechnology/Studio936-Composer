// Studio 936 Composer - Suite Pro Structure / ADN Module v4.7.2 Cambio 68
...
// Cambio 68: fix — el panel Ly Letra solo se podía redimensionar verticalmente.
// La causa: una regla CSS posterior fijaba "width" con !important, ganando
// siempre sobre el estilo inline que aplica el arrastre nativo del navegador
// (resize:both ya estaba activo). Se quitó ese !important; ahora el ancho se
// puede arrastrar igual que el alto.
(function () {
  "use strict";
  ...
  const MODULE_CAMBIO_LABEL = "Cambio 68";

  const STYLE_ID = "s936SuiteProStructureStylesV472Cambio68";
