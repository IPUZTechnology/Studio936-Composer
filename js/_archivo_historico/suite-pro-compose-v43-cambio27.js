...
`;
  ...
  function render(ctx) {
    ...
    const banner = ctx.el("div", "s936-cmp-change-banner", "Cambio número 27 · Holds invisibles en reposo + play limpio");
    ...
    try {
      ...
      box.innerHTML = "<b>Cambio número 27 · Estructura no pudo renderizar.</b><br>El error queda visible en pantalla. Revisa la primera línea roja de consola.";
