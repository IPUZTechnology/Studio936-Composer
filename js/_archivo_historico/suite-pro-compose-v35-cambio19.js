// Studio 936 Composer - Suite Pro Compose Coordinator v3.5 Cambio 19
...
`;
  ...
  function render(ctx) {
    ...
    const banner = ctx.el("div", "s936-cmp-change-banner", "Cambio número 19 · Main controla instrumento + Chart alto");
