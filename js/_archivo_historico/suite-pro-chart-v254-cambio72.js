// Studio 936 Composer - Chart View v2.5.4 Cambio 72 (DEBUG LYRICS HELPER)
...
// Cambio 72: se agrega window.s936DebugLyrics() — diagnóstico manual que
// compara las claves de sección guardadas en localStorage contra las que el
// Chart usa AHORA MISMO en pantalla, para encontrar bugs de sección-no-
// coincide sin adivinar. No cambia comportamiento visual ni de guardado.
window.Studio936SuiteProChart = (() => {
  "use strict";
  const VERSION = "chart-v2.5.4-cambio-72";
  const STYLE_ID = "s936-chart-v254-cambio72";
...
`;
  ...
  function render({ container, instrument, onChordEdit } = {}) {
    ...
    metaEl.textContent = (edState.style || "") + (edState.bpm ? " · " + edState.bpm + " BPM" : "") + " · " + totalBars + " comp. · CHART CAMBIO 72";
