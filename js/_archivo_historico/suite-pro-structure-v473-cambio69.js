// Studio 936 Composer - Suite Pro Structure / ADN Module v4.7.3 Cambio 69
...
// Cambio 69: los íconos chicos "💾 Guardar" y "⇢ Mover al tablero" ya llamaban
// exactamente al mismo guardado que el botón grande de abajo (confirmado:
// el botón grande SÍ refleja en el Chart) — el problema era solo de mensaje:
// el aviso decía "preparada para tablero", dando a entender que faltaba un
// paso. Ahora confirman claramente "Guardado y reflejado en el Chart."
(function () {
  "use strict";
  ...
  const MODULE_CAMBIO_LABEL = "Cambio 69";

  const STYLE_ID = "s936SuiteProStructureStylesV473Cambio69";
