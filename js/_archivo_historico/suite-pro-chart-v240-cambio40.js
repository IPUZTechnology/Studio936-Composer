// Studio 936 Composer - Chart View v2.4.0 Cambio 40 (CONSOLA POR SECCIÓN FUNCIONAL)
...
window.Studio936SuiteProChart = (() => {
  "use strict";
  const VERSION = "chart-v2.4.0-cambio-40";
  const STYLE_ID = "s936-chart-v240-cambio40";
