// Studio 936 Composer - Suite Pro Structure / ADN Module v4.8.7 Cambio 91 (HOTFIX)
...
// Cambio 91 (HOTFIX): encontrada la causa REAL de la doble barra específica
// del laptop — la tarjeta "ARREGLO DE LA CANCIÓN" (.s936-struct-arrangement-
// full) tenía su PROPIO scroll independiente con max-height basado en 100vh.
// En un monitor extendido (alto de pantalla grande) esa cuenta daba espacio
// de sobra y no se notaba; en el laptop (pantalla más corta) sí se volvía
// scrolleable por sí sola, sumándose al scroll general del panel. Se quita
// el scroll propio de esa tarjeta — ahora fluye normal dentro del panel.
(function () {
  "use strict";
  ...
  const MODULE_CAMBIO_LABEL = "Cambio 91";

  const STYLE_ID = "s936SuiteProStructureStylesV487Cambio91";
