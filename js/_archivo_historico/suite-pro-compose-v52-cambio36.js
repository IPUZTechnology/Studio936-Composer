// Studio 936 Composer - Suite Pro Compose Coordinator v5.2 Cambio 36
...
(function () {
  ...
  const STYLE_ID = "s936SuiteProComposeStylesCambio35";
  ...
  function register() {
    ...
    window.Studio936SuiteProCompose = { version: "compose-v5.0-cambio-34", render };
...
/* Cambio 36 · Dock más limpio: sin título interno y submenús más compactos */
...
`;
    style.textContent += `
/* Cambio 36 · Menú superior como trio premium COMPOSE / STUDIO / MENÚ */
#s936SuitePro .s936-compose-top-menu-host{
...
`;
  ...
  function render(ctx) {
    ...
    // Cambio 36: sin título interno "Composición Pro"; el modo ya vive en la pestaña COMPOSE.
    const shell = ctx.el("div", "s936-cmp-shell");

    // Cambio 36: el menú queda como herramienta de Compose; Mapa Maestro vuelve a subnav.
    ...
    // Cambio 36: herramientas históricas vuelven al menú Compose sin perderse.
    ...
    try {
      ...
      box.innerHTML = "<b>Cambio número 35 · Estructura no pudo renderizar.</b><br>El error queda visible en pantalla. Revisa la primera línea roja de consola.";
  ...
  function renderComposeSongMenu(ctx, shell) {
    // Cambio 36: el menú queda como herramienta de Compose; no reemplaza Mapa Maestro.
    ...
    setTimeout(() => {
      try {
        ...
        console.warn("Cambio 36 menú Compose:", err);
