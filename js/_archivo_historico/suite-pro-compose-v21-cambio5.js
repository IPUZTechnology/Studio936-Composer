// Studio 936 Composer - Suite Pro Compose Coordinator v2.1 Cambio 5
...
(function () {
  ...
  const STYLE_ID = "s936SuiteProComposeStylesCambio5";
...
`;
  ...
  function render(ctx) {
    ...
    const banner = ctx.el("div", "s936-cmp-change-banner", "Cambio número 5 · Tracker activo");
    ...
    try {
      ...
      console.error("Suite Pro Compose Cambio 5 render error:", error);
      const box = ctx.el("section", "s936-cmp-render-error");
      box.innerHTML = "<b>Cambio número 5 · Estructura no pudo renderizar.</b><br>El error queda visible en pantalla. Revisa la primera línea roja de consola.";
