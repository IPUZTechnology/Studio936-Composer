// Studio 936 Composer - Suite Pro Compose Coordinator v2.8 Cambio 12
...
`;
  ...
  function render(ctx) {
    ...
    const banner = ctx.el("div", "s936-cmp-change-banner", "Cambio número 12 · Mini consola rítmica ilumina el Chart");
