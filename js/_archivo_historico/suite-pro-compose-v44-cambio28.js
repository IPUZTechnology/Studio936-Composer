// Studio 936 Composer - Suite Pro Compose Coordinator v4.4 Cambio 28
...
(function () {
  ...
  const STYLE_ID = "s936SuiteProComposeStylesCambio28";
...
`;
  ...
  function render(ctx) {
    ...
    const banner = ctx.el("div", "s936-cmp-change-banner", "Cambio número 28 · Escenario alto + play superior unificado");
    ...
    try {
      ...
      box.innerHTML = "<b>Cambio número 28 · Estructura no pudo renderizar.</b><br>El error queda visible en pantalla. Revisa la primera línea roja de consola.";
