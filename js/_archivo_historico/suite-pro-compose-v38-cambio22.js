// Studio 936 Composer - Suite Pro Compose Coordinator v3.6 Cambio 22
...
`;
  ...
  function render(ctx) {
    ...
    const banner = ctx.el("div", "s936-cmp-change-banner", "Cambio número 22 · Mini consola izquierda + Chart limpio");
    ...
    try {
      ...
      console.error("Suite Pro Compose Cambio 22 render error:", error);
      const box = ctx.el("section", "s936-cmp-render-error");
      box.innerHTML = "<b>Cambio número 22 · Estructura no pudo renderizar.</b><br>El error queda visible en pantalla. Revisa la primera línea roja de consola.";
