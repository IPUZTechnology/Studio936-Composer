// Studio 936 Composer - Suite Pro Structure / ADN Module v4.3.4 Cambio 29
...
(function () {
  ...
  const STYLE_ID = "s936SuiteProStructureStylesV434Cambio29";
...
`;
  ...
  function renderChangeBanner(ctx, root) {
    const banner = ctx.el("div", "s936-struct-change-banner", "Cambio número 29 · panel izquierdo como consola por sección");
    ...
    const mount = (attempt = 0) => {
      ...
      if (!Chart || typeof Chart.mountInRightPanel !== "function") {
        ...
        if (attempt < 12) {
          ...
          status.textContent = "Cambio número 29 · No encontré Studio936SuiteProChart.mountInRightPanel(). Revisa que index.html cargue suite-pro-chart-v229-cambio29.js.";
      ...
      try {
        ...
        if (result && result.ok) {
          status.textContent = "Cambio número 29 · Chart montado. Panel izquierdo = consola por sección.";
