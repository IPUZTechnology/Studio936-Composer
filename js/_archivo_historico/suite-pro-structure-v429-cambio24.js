// Studio 936 Composer - Suite Pro Structure / ADN Module v4.2.8 Cambio 24
...
(function () {
  ...
  const STYLE_ID = "s936SuiteProStructureStylesV429Cambio24";
...
`;
  ...
  function renderChangeBanner(ctx, root) {
    const banner = ctx.el("div", "s936-struct-change-banner", "Cambio número 24 · Menú mini + compás sostenido limpio");
