// Studio 936 Composer - Suite Pro Structure / ADN Module v4.7.4 Cambio 70
...
// Cambio 70: diagnóstico — el refresco del Chart tras guardar fallaba en
// silencio si no encontraba el panel (#s936-chart-view-panel) en ese momento,
// sin ningún aviso ni error en consola. Ahora reintenta una vez, deja rastro
// en console.warn, y si de verdad falla avisa al usuario con un toast claro.
// También se detecta si el guardado en localStorage falla (ej. modo incógnito).
(function () {
  "use strict";
  ...
  const MODULE_CAMBIO_LABEL = "Cambio 70";

  const STYLE_ID = "s936SuiteProStructureStylesV474Cambio70";
