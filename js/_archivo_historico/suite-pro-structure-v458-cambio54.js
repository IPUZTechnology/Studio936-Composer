// Studio 936 Composer - Suite Pro Structure / ADN Module v4.5.8 Cambio 54 (HOTFIX)
...
// Cambio 54 (HOTFIX): corrige un bug real de Cambio 53 — el popover de nota/duración
// (pentagrama + figuras) quedaba SIEMPRE visible en cada celda, tapando la letra,
// porque "display:flex" en su CSS le ganaba en cascada al atributo [hidden]. Se
// restaura el comportamiento correcto: cerrado por defecto, se abre solo al clic.
(function () {
  "use strict";

  const STYLE_ID = "s936SuiteProStructureStylesV458Cambio54";
    ...
    function saveLyrics(closeAfterSave) {
      ...
      try {
        window.dispatchEvent(new CustomEvent("studio936:section-lyrics-updated", {
          detail: { section, label, bars, beats: nextBeats, lines: nextLines, durations: nextDurations, pitches: nextPitches, source: "structure-lyrics-floating-editor" }
        }));
      } catch(_) {}
