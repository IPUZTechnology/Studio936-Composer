// Studio 936 Composer - Suite Pro Structure / ADN Module v4.3.1 Cambio 26
...
`;
  ...
  function renderChangeBanner(ctx, root) {
    const banner = ctx.el("div", "s936-struct-change-banner", "Cambio número 26 · Holds invisibles en reposo + play limpio");
