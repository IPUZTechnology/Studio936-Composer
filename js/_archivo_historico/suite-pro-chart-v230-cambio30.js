// Studio 936 Composer - Chart View v2.3.0 Cambio 30 (DOCK LIMPIO + CONSOLA POR CANAL)
...
window.Studio936SuiteProChart = (() => {
  "use strict";
  const VERSION = "chart-v2.3.0-cambio-30";
  const STYLE_ID = "s936-chart-v230-cambio30";
...
.s936-ch-beat.compact-hold.active-beat .s936-ch-rhythm-mark{
  ...
  function render({ container, instrument, onChordEdit } = {}) {
    ...
    changeBanner.textContent = "Cambio número 30 · Chart limpio + consola por canal";
