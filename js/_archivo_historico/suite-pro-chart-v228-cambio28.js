// Studio 936 Composer - Chart View v2.2.8 Cambio 28 (ESCENARIO ALTO + PLAY SUPERIOR UNIFICADO)
...
window.Studio936SuiteProChart = (() => {
  "use strict";
  const VERSION = "chart-v2.2.8-cambio-28";
  const STYLE_ID = "s936-chart-v228-cambio28";
...
.s936-ch-beat.compact-hold.active-beat .s936-ch-rhythm-mark{
  ...
  function render({ container, instrument, onChordEdit } = {}) {
    ...
    changeBanner.textContent = "Cambio número 28 · escenario alto + play superior unificado";
