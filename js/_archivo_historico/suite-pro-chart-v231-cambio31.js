// Studio 936 Composer - Chart View v2.3.1 Cambio 31 (CONSOLA POR SECCIÓN FUNCIONAL)
...
window.Studio936SuiteProChart = (() => {
  "use strict";
  const VERSION = "chart-v2.3.1-cambio-31";
  const STYLE_ID = "s936-chart-v231-cambio31";
...
.s936-ch-beat.compact-hold.active-beat .s936-ch-rhythm-mark{
  ...
  function render({ container, instrument, onChordEdit } = {}) {
    ...
    changeBanner.textContent = "Cambio número 31 · Chart limpio + consola por canal";
