// Studio 936 Composer - Suite Pro Structure / ADN Module v4.6.2 Cambio 58
...
// Cambio 58: (1) el badge de nota deja de superponerse dentro del cuadro de
// texto — ahora es un elemento propio, debajo, sin taparlo (la nota como guía
// dentro del placeholder se mantiene); (2) se reemplaza el "portal" a <body>
// con position:fixed (frágil por el backdrop-filter del panel) por una técnica
// más simple: abrir el overflow del panel mientras el popover está abierto.
// Esto también resuelve que el pentagrama apareciera mal ubicado cerca del dock.
(function () {
  "use strict";

  const STYLE_ID = "s936SuiteProStructureStylesV462Cambio58";
