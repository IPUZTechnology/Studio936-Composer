// Studio 936 Composer - Suite Pro Structure / ADN Module v4.8.0 Cambio 80
...
// Cambio 80: el ancho del panel Ly Letra ya no usa un tope fijo (1180px) ni
// el ancho total de la ventana — va desde el borde del dock hasta el borde
// derecho REAL del Chart (el contenedor de los compases), para no quedar
// más angosto ni más ancho que la partitura visible.
(function () {
  "use strict";
  ...
  const MODULE_CAMBIO_LABEL = "Cambio 80";

  const STYLE_ID = "s936SuiteProStructureStylesV480Cambio80";
