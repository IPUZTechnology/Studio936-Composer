// Studio 936 Composer - Suite Pro Compose Coordinator v2.2 Cambio 6
...
`;
  ...
  function render(ctx) {
    ...
    const banner = ctx.el("div", "s936-cmp-change-banner", "Cambio número 7 · Popup único con mapa editable directo");
    ...
    try {
      ...
      box.innerHTML = "<b>Cambio número 7 · Estructura no pudo renderizar.</b><br>El error queda visible en pantalla. Revisa la primera línea roja de consola.";
