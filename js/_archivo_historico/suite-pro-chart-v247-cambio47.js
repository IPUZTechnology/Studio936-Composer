// Studio 936 Composer - Chart View v2.4.7 Cambio 47 (LYRICS FLOATING / BEATS)
...
window.Studio936SuiteProChart = (() => {
  "use strict";
  const VERSION = "chart-v2.4.7-cambio-47";
  const STYLE_ID = "s936-chart-v247-cambio47";
...
/* Cambio 47 · lyrics más grandes y por tiempos en Chart */
.s936-ch-lyric-line{
    ...
    if (lyricData && lyricData.text) {
      ...
      if (hasBeatLyrics) {
        ...
        [0, 1, 2, 3].forEach((beat) => {
          ...
          span.className = "s936-ch-lyric-beat" + (value ? " has-text" : "");
          span.dataset.beat = String(beat + 1);
