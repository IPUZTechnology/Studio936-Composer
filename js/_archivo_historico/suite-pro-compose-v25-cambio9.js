...
`;
  ...
  function render(ctx) {
    ...
    const banner = ctx.el("div", "s936-cmp-change-banner", "Cambio número 9 · Ritmo en vivo dentro del popup");
    ...
    try {
      ...
      box.innerHTML = "<b>Cambio número 9 · Estructura no pudo renderizar.</b><br>El error queda visible en pantalla. Revisa la primera línea roja de consola.";
