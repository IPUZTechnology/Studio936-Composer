// Studio 936 Composer - Suite Pro Structure / ADN Module v4.5.4 Cambio 49
...
(function () {
  ...
  const STYLE_ID = "s936SuiteProStructureStylesV454Cambio49";
...
`;
  ...
  function openSectionLyricsEditor(ctx, s, part, parts) {
    ...
    const titleText = ctx.el("b", "", "Ly · Editor de letras");
    titleText.title = "Editor flotante de letra por compás y por tiempo";
    const titleHint = ctx.el("small", "", label + " · arrastra esta pantalla de vidrio y escribe mirando el Chart.");
    titleHint.title = "Mueve, agranda o achica esta ventana mientras trabajas sobre la sección actual.";
    ...
    const help = ctx.el("div", "s936-lyrics-help", "Réplica vacía de la sección actual: 4 compases por línea, 4 tiempos por compás y guía armónica del Chart en cada tiempo.");
