// Studio 936 Composer - Chart View v2.5.2 Cambio 52 (LYRICS RIBBON FIX + SUSTAIN KARAOKE)
...
// Cambio 52: la letra de compases % ya vive en la misma cinta que el resto (no
// flotando dentro de la caja %); el resaltado karaoke ahora sostiene la palabra
// activa durante toda su duración (2T/3T/4T), no solo en su primer tiempo; texto
// de la cinta más grande. No agrega audio/motor nuevo.
window.Studio936SuiteProChart = (() => {
  "use strict";
  const VERSION = "chart-v2.5.2-cambio-52";
  const STYLE_ID = "s936-chart-v252-cambio52";
