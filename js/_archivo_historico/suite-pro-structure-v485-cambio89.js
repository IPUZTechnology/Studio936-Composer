// Studio 936 Composer - Suite Pro Structure / ADN Module v4.8.5 Cambio 89 (HOTFIX)
...
// Cambio 89 (HOTFIX): se encontraron y neutralizaron dos reglas viejas
// (Cambio 39 y Cambio 44) que ponían "#s936SuitePro{overflow-y:auto!important}"
// — esto le ganaba al overflow:hidden que suite-pro.js le pone al mismo
// panel exterior (Cambio 87), causando una segunda barra de scroll pegada
// a la del contenido interno. Ahora solo el contenido interno scrollea.
(function () {
  "use strict";
  ...
  const MODULE_CAMBIO_LABEL = "Cambio 89";

  const STYLE_ID = "s936SuiteProStructureStylesV485Cambio89";
