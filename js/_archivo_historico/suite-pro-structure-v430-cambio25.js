// Studio 936 Composer - Suite Pro Structure / ADN Module v4.3.0 Cambio 25
...
(function () {
  ...
  const STYLE_ID = "s936SuiteProStructureStylesV429Cambio25";
...
`;
  ...
  function renderChangeBanner(ctx, root) {
    const banner = ctx.el("div", "s936-struct-change-banner", "Cambio número 25 · Hold inteligente + menú de práctica limpio");
