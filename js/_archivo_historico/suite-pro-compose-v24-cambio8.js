// Studio 936 Composer - Suite Pro Compose Coordinator v2.4 Cambio 8
...
`;
  ...
  function render(ctx) {
    ...
    const banner = ctx.el("div", "s936-cmp-change-banner", "Cambio número 8 · Popup centrado + audio interno del mapa");
    ...
    try {
      ...
      box.innerHTML = "<b>Cambio número 8 · Estructura no pudo renderizar.</b><br>El error queda visible en pantalla. Revisa la primera línea roja de consola.";
