// Studio 936 Composer - Chart View v2.1.8 Cambio 19 (CONTROLES MAIN PRESERVADOS + MARCAS VISIBLES)
...
window.Studio936SuiteProChart = (() => {
  "use strict";
  const VERSION = "chart-v2.1.8-cambio-19";
  const STYLE_ID = "s936-chart-v218-cambio19";
...
/* Cambio 19 · escenario Chart sin borrar los comandos Groove del Main */
...
.s936-repeat-practice-cell.active{
  ...
  function render({ container, instrument, onChordEdit } = {}) {
    ...
    changeBanner.textContent = "Cambio número 19 · Main conserva groove + Chart escenario musical";
  ...
  function mountInRightPanel({ onChordEdit } = {}) {
    ...
    // Cambio 19: NO escondemos los comandos Groove/Play/Metronomo del Main.
