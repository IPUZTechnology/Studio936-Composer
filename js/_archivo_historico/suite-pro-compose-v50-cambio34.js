// Studio 936 Composer - Suite Pro Compose Coordinator v4.9 Cambio 34
...
(function () {
  ...
  const STYLE_ID = "s936SuiteProComposeStylesCambio34";
...
`;
  ...
  function render(ctx) {
    ...
    // Cambio 34: el menú queda como herramienta de Compose; Mapa Maestro vuelve a subnav.
    ...
    // Cambio 34: herramientas históricas vuelven al menú Compose sin perderse.
    ...
    try {
      ...
      box.innerHTML = "<b>Cambio número 34 · Estructura no pudo renderizar.</b><br>El error queda visible en pantalla. Revisa la primera línea roja de consola.";
  ...
  function renderComposeSongMenu(ctx, shell) {
    // Cambio 34: el menú queda como herramienta de Compose; no reemplaza Mapa Maestro.
    ...
    setTimeout(() => {
      try {
        ...
        console.warn("Cambio 34 menú Compose:", err);
