// Studio 936 Composer - Chart View v2.2.5 Cambio 25 (HOLD INTELIGENTE + MENÚ MINI)
...
window.Studio936SuiteProChart = (() => {
  "use strict";
  const VERSION = "chart-v2.2.5-cambio-25";
  const STYLE_ID = "s936-chart-v225-cambio25";
...
/* Cambio 25 · menú de práctica extra compacto y menos invasivo */
.s936-bar-menu-practice-mini{
...
/* Cambio 25 · sostenidos más limpios: sin mapa, solo símbolo + acorde */
.s936-ch-beat.compact-hold .s936-ch-beat-chord{
...
.s936-ch-beat.compact-hold .s936-ch-hold-chord{
  ...
  function renderBar({ barIndex, sectionKey, beatsData, rhythmData, barInfo, inst, voicingLibrary, onRerender, navMarks }) {
    ...
    head.title = "Cambio 25: clic para práctica local de este compás.";
    head.tabIndex = 0;
  ...
  function render({ container, instrument, onChordEdit } = {}) {
    ...
    changeBanner.textContent = "Cambio número 25 · Hold inteligente + menú mini de práctica";
