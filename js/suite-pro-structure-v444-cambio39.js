// Studio 936 Composer - Suite Pro Structure / ADN Module v4.4.4 Cambio 39
...
(function () {
  ...
  const STYLE_ID = "s936SuiteProStructureStylesV444Cambio39";
...
`;
  ...
  function scheduleRightPanelChart(ctx, root) {
    ...
    const ensureChartScriptLoaded = () => {
      ...
      script.src = src + "?v=cambio-39-20260701";
