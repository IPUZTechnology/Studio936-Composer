// Studio 936 Composer - Suite Pro Compose Coordinator v5.1 Cambio 35
...
/* Cambio 35 · Dock más limpio: sin título interno y submenús más compactos */
...
`;
  ...
  function render(ctx) {
    ...
    // Cambio 35: sin título interno "Composición Pro"; el modo ya vive en la pestaña COMPOSE.
    const shell = ctx.el("div", "s936-cmp-shell");

    // Cambio 35: el menú queda como herramienta de Compose; Mapa Maestro vuelve a subnav.
    ...
    // Cambio 35: herramientas históricas vuelven al menú Compose sin perderse.
  ...
  function renderComposeSongMenu(ctx, shell) {
    // Cambio 35: el menú queda como herramienta de Compose; no reemplaza Mapa Maestro.
    ...
    setTimeout(() => {
      try {
        ...
        console.warn("Cambio 35 menú Compose:", err);
