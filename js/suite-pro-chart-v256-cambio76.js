// Studio 936 Composer - Chart View v2.5.6 Cambio 76 (KARAOKE VUELVE A CINTA FLUIDA)
...
// Cambio 76: se revierte el grid del Cambio 74 (daba apariencia de
// cuadrícula/numeración no deseada) — la cinta de letra vuelve a ser una
// sola línea fluida (flex), tal como era antes y el usuario confirmó que
// era correcta. La correspondencia con el tiempo real sigue intacta vía
// data-section/data-bar/data-beat en cada palabra (usados por el karaoke).
window.Studio936SuiteProChart = (() => {
  "use strict";
  const VERSION = "chart-v2.5.6-cambio-76";
  const STYLE_ID = "s936-chart-v256-cambio76";
...
/* Cambio 76: se revierte el grid del Cambio 74 — el usuario confirmó que la
   cinta fluida de una sola línea (sin cuadrícula) ya era la correcta;
   el grid generaba una apariencia de "cuadrícula numerada" no deseada.
   La coincidencia real con el tiempo/compás sigue garantizada por los
   atributos data-section/data-bar/data-beat de cada palabra (los mismos
   que usa el resaltado karaoke) — eso no depende de si el layout visual
   es flex o grid. */
.s936-ch-lyric-beats{
  display:flex;
  flex-wrap:wrap;
...
`;
  ...
  function render({ container, instrument, onChordEdit } = {}) {
    ...
    metaEl.textContent = (edState.style || "") + (edState.bpm ? " · " + edState.bpm + " BPM" : "") + " · " + totalBars + " comp. · CHART CAMBIO 76";
