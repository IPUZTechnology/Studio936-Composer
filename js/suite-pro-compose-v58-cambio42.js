// Studio 936 Composer - Suite Pro Compose Coordinator v5.8 Cambio 42
...
`;
    ...
    style.textContent += `
/* Cambio 42 · Subnav estable sin romper escenario Chart: conserva Mapa Maestro y deja Tab Pro discreto si aún no tiene módulo real */
#s936SuitePro .s936-compose-subrail{
  max-width:100%!important;
  overflow-x:hidden!important;
}
...
`;
    ...
    style.textContent += `
/* Cambio 42 · Top menu estable y subnav sin invadir ni generar scroll horizontal */
html, body{
  overflow-x:hidden!important;
}
#s936SuitePro{
