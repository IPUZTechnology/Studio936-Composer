// Studio 936 Composer - Suite Pro Compose Coordinator v3.8 Cambio 25
...
(function () {
  ...
  const STYLE_ID = "s936SuiteProComposeStylesCambio25";
...
`;
  ...
  function render(ctx) {
    ...
    const banner = ctx.el("div", "s936-cmp-change-banner", "Cambio número 25 · Hold inteligente + menú de práctica limpio");
    ...
    try {
      ...
      box.innerHTML = "<b>Cambio número 25 · Estructura no pudo renderizar.</b><br>El error queda visible en pantalla. Revisa la primera línea roja de consola.";
