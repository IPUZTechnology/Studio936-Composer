// Studio 936 Composer - Chart View v2.0.8 Cambio 9 (RITMO EN VIVO + PULSO OPCIONAL)
...
window.Studio936SuiteProChart = (() => {
  "use strict";
  const VERSION = "chart-v2.0.8-cambio-9";
  const STYLE_ID = "s936-chart-v208-cambio9";
...
.s936-ch-dblbar{height:3px;margin-top:2px;background:linear-gradient(to right,rgba(255,255,255,.15) 0,rgba(255,255,255,.15) calc(100% - 4px),rgba(255,255,255,.5) calc(100% - 4px),rgba(255,255,255,.5) 100%)}
  ...
  function showBeatPop(targetEl, label, currentVal, inst, onSave, onOpenVoicing) {
    ...
    pop.className = "s936-ch-pop s936-ch-pop-v7 s936-ch-pop-v8 s936-ch-pop-v9";
    ...
    drag.innerHTML = `<span>${label}</span><small>Arrastra · cambio 9</small>`;
  ...
  function render({ container, instrument, onChordEdit } = {}) {
    ...
    changeBanner.textContent = "Cambio número 9 · Ritmo en vivo sigue el acorde del popup";
