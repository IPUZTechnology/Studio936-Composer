// Studio 936 Composer - Chart View v2.3.7 Cambio 37 (CONSOLA POR SECCIÓN FUNCIONAL)
...
window.Studio936SuiteProChart = (() => {
  "use strict";
  const VERSION = "chart-v2.3.7-cambio-37";
  const STYLE_ID = "s936-chart-v237-cambio37";
...
/* Cambio 37 · Escenario más alto: Chart pegado a los controles superiores. */
body.s936-chart-stage .status-bar{
  min-height:30px!important;
