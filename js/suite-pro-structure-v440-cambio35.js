// Studio 936 Composer - Suite Pro Structure / ADN Module v4.4.0 Cambio 35
...
/* Cambio 35 · Limpieza del dock: no trackers/banners temporales */
#s936SuitePro .s936-struct-change-banner,
#s936SuitePro .s936-struct-right-status,
#s936SuitePro .s936-ckpt-topbar,
...
/* Cambio 35 · Dock como consola por sección: menú arriba, botones sobrios y agrupados */
#s936SuitePro .s936-ckpt-topbar,
#s936SuitePro .s936-ckpt-topbar-compact,
#s936SuitePro .s936-ckpt-menu-btn-wide,
#s936SuitePro .s936-ckpt-dropdown{
...
`;
    style.textContent += `
/* Cambio 35 · Panel izquierdo autoajustado y más compacto.
...
`;
  ...
  function render(ctx, shell) {
    ...
    // Cambio 35: sin banners temporales en el dock; el menú de canción vive en Compose.
    ...
    try {
      ...
      // Cambio 35: el menú de canción sube al nivel Compose; no duplicar cabecera en Estructura.
  ...
  function renderChangeBanner(ctx, root) { /* Cambio 35: tracker visual removido del dock. */ }
