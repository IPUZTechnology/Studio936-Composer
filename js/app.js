...
function soloEventAtStep(events,step){ return Transport.soloEventAtStep(events,step); }
function bassPatternNote(bass,chordNotes,step,style){ return Transport.bassPatternNote(bass,chordNotes,step,style); }
function whileInRange(n,min,max){ return Transport.whileInRange(n,min,max); }
function thinChord(notes){ return Transport.thinChord(notes); }
