...
(() => {
  ...
  function ensureToolsDrawer(){
    ...
    // The active Suite Pro panel is owned by js/pro-suite.js.
    return null;
  }
...
(function(){
  ...
  function ensureSuiteProMounted(){
    // Suite Pro is owned by js/pro-suite.js. app.js must not create or populate legacy v18 Suite UI.
    ...
    return document.getElementById('v18Suite');
  }
  ...
  function ensureSuitePanelIntegrity(suite){
    // Suite Pro is owned by js/pro-suite.js. Do not rebuild legacy buttons here.
  ...
  function toggleSuite(){
    ...
    const suite = document.getElementById('v18Suite');
    if(suite) suite.classList.toggle('v19-open');
  }
