...
`;
  ...
  function render(ctx) {
    ...
    const banner = ctx.el("div", "s936-cmp-change-banner", "Cambio número 6 · Popup de acordes con mapa previo");
    ...
    try {
      ...
      box.innerHTML = "<b>Cambio número 6 · Estructura no pudo renderizar.</b><br>El error queda visible en pantalla. Revisa la primera línea roja de consola.";
