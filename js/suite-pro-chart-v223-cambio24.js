...
window.Studio936SuiteProChart = (() => {
  "use strict";
  const VERSION = "chart-v2.2.3-cambio-24";
  const STYLE_ID = "s936-chart-v223-cambio24";
...
.s936-ch-sec-navmark-badge{
  ...
  function showBarContextMenu(event, { sectionKey, barIndex, onRerender }) {
    ...
    addButton("Limpiar Loop", () => clearPracticeMarks(sectionKey), "danger", "Quita loop inicio, loop final y practicar desde aquí de esta sección.");
  ...
  function renderBar({ barIndex, sectionKey, beatsData, rhythmData, barInfo, inst, voicingLibrary, onRerender, navMarks }) {
    ...
    head.title = "Cambio 24: clic para práctica local de este compás.";
    head.tabIndex = 0;
  ...
  function render({ container, instrument, onChordEdit } = {}) {
    ...
    changeBanner.textContent = "Cambio número 24 · Menú mini + compás sostenido limpio";
