// Studio 936 Composer - Chart View v2.3.3 Cambio 34 (CONSOLA POR SECCIÓN FUNCIONAL)
...
window.Studio936SuiteProChart = (() => {
  "use strict";
  const VERSION = "chart-v2.3.3-cambio-33";
  const STYLE_ID = "s936-chart-v233-cambio34";
