// Studio 936 Composer - Chart View v2.3.5 Cambio 35 (CONSOLA POR SECCIÓN FUNCIONAL)
...
window.Studio936SuiteProChart = (() => {
  "use strict";
  const VERSION = "chart-v2.3.5-cambio-35";
  const STYLE_ID = "s936-chart-v235-cambio35";
...
/* Cambio 35 · Escenario más alto: Chart pegado a los controles superiores. */
body.s936-chart-stage .status-bar{
  min-height:30px!important;
