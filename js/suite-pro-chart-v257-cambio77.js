// Studio 936 Composer - Chart View v2.5.7 Cambio 77 (KARAOKE ALINEADO POR TIEMPO, SIN CUADRÍCULA)
...
// (grid de 4 columnas, igual que la fila de acordes), pero sin bordes, fondos
// ni números — sigue viéndose como texto fluido, no cuadrícula. Así, al
// reproducir, el resaltado karaoke cae justo en el lugar correcto.
window.Studio936SuiteProChart = (() => {
  "use strict";
  const VERSION = "chart-v2.5.7-cambio-77";
  const STYLE_ID = "s936-chart-v257-cambio77";
...
`;
  ...
  function render({ container, instrument, onChordEdit } = {}) {
    ...
    metaEl.textContent = (edState.style || "") + (edState.bpm ? " · " + edState.bpm + " BPM" : "") + " · " + totalBars + " comp. · CHART CAMBIO 77";
