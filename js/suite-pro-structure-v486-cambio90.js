// Studio 936 Composer - Suite Pro Structure / ADN Module v4.8.6 Cambio 90 (HOTFIX)
...
// Cambio 90 (HOTFIX): se encontraron 4 reglas viejas (Cambios 39/40/44 y una
// responsive) que fijaban el ANCHO de #s936SuitePro con !important SIN
// excluir el modo MAX — por eso el dock "ya no se podía maximizar de
// verdad" (el ancho se quedaba achicado igual). Se les agrega ":not(.is-max)"
// a las 4, para que el modo MAX pueda expandirse como corresponde.
(function () {
  "use strict";
  ...
  const MODULE_CAMBIO_LABEL = "Cambio 90";

  const STYLE_ID = "s936SuiteProStructureStylesV486Cambio90";
