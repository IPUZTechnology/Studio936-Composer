// Studio 936 Composer - Suite Pro Structure / ADN Module v4.4.3 Cambio 38
...
(function () {
  ...
  const STYLE_ID = "s936SuiteProStructureStylesV443Cambio38";
  ...
  function register() {
    ...
    window.Studio936SuiteProStructure = { version: "structure-v4.4.3-cambio-38", render };
...
/* Cambio 38 · Limpieza del dock: no trackers/banners temporales */
#s936SuitePro .s936-struct-change-banner,
#s936SuitePro .s936-struct-right-status,
#s936SuitePro .s936-ckpt-topbar,
...
/* Cambio 38 · Dock como consola por sección: menú arriba, botones sobrios y agrupados */
#s936SuitePro .s936-ckpt-topbar,
#s936SuitePro .s936-ckpt-topbar-compact,
#s936SuitePro .s936-ckpt-menu-btn-wide,
#s936SuitePro .s936-ckpt-dropdown{
...
`;
    style.textContent += `
/* Cambio 38 · Panel izquierdo autoajustado y más compacto.
...
`;
    style.textContent += `
/* Cambio 38 · Consola por sección más clara: nombre primero, botones definidos y flechas compactas */
#s936SuitePro .s936-struct-card.s936-struct-arrangement-full{
...
`;
    ...
    style.textContent += `
/* Cambio 38 · Consola por sección: botones principales más legibles y mover compacto */
#s936SuitePro .s936-struct-card.s936-struct-arrangement-full{
...
`;
    style.textContent += `
/* Cambio 38 · Consola izquierda compacta: tag + tooltip, nombres ocultos y dock flexible */
#s936SuitePro{
...
`;
  ...
  function render(ctx, shell) {
    ...
    // Cambio 38: sin banners temporales en el dock; el menú de canción vive en Compose.
    ...
    try {
      ...
      // Cambio 38: el menú de canción sube al nivel Compose; no duplicar cabecera en Estructura.
      ...
      err.innerHTML = "<h4>Cambio número 37 · Error visible en Estructura</h4><p>No se pudo construir el panel. Revisa la primera línea roja de consola.</p>";
  ...
  function renderChangeBanner(ctx, root) { /* Cambio 38: tracker visual removido del dock. */ }
    ...
    const mount = (attempt = 0) => {
      ...
      if (!Chart || typeof Chart.mountInRightPanel !== "function") {
        ...
        if (attempt < 12) {
          ...
          status.textContent = "Cambio número 37 · No encontré Studio936SuiteProChart.mountInRightPanel(). Revisa que index.html cargue suite-pro-chart-v237-cambio37.js.";
  ...
  function partRow(ctx, s, parts, part, index) {
    ...
    // Cambio 38 · Mover sección como micro-stepper vertical para ahorrar espacio
