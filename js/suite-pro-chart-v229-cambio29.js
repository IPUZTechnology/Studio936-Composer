// Studio 936 Composer - Chart View v2.2.9 Cambio 29 (FOCUS SECTION + CONSOLA POR SECCIÓN)
...
window.Studio936SuiteProChart = (() => {
  "use strict";
  const VERSION = "chart-v2.2.9-cambio-29";
  const STYLE_ID = "s936-chart-v229-cambio29";
...
.s936-ch-beat.compact-hold.active-beat .s936-ch-rhythm-mark{
  ...
  function render({ container, instrument, onChordEdit } = {}) {
    ...
    changeBanner.textContent = "Cambio número 29 · Chart filtrable por sección + consola por canal";
