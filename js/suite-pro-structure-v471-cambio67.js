// Studio 936 Composer - Suite Pro Structure / ADN Module v4.7.1 Cambio 67
...
// Cambio 67: el pentagrama queda cerrado/estable (no se toca más). En el
// cuadro de texto de la letra: (1) tamaño de fuente reducido (estaba muy
// grande); (2) se quita la guía de nota del placeholder — el cuadro solo
// debe mostrar lo que el usuario escriba, la nota vive en el pentagrama/ícono.
(function () {
  "use strict";
  ...
  const MODULE_CAMBIO_LABEL = "Cambio 67";

  const STYLE_ID = "s936SuiteProStructureStylesV471Cambio67";
