// Studio 936 Composer - Suite Pro Structure / ADN Module v4.4.8 Cambio 44
  ...
  function installDockFlexGuard() {
    ...
    const sync = () => {
      try {
        ...
        if (chartPanel) {
          // Cambio 44: no empujar el Chart con margin-left; eso generaba scroll horizontal
...
`;
  ...
  function render(ctx, shell) {
    ...
    try {
      ...
      err.innerHTML = "<h4>Cambio número 37 · Cambio número 44 · Error visible en Estructura</h4><p>No se pudo construir el panel. Revisa la primera línea roja de consola.</p>";
  ...
  function renderBuilder(ctx, root, s, parts) {
    ...
    if (focusedPart) {
      // Cambio 44: se elimina el header grande "Zoom sección".
  ...
  function partRow(ctx, s, parts, part, index) {
    ...
    // Cambio 44: en Zoom sección, la barra del canal solo deja los controles principales.
