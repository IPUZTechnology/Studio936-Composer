// Studio 936 Composer - Suite Pro Structure / ADN Module v4.6.0 Cambio 56
...
// Cambio 56: un tiempo se puede dividir en 2, 3 o 4 sílabas (corcheas/semicorcheas),
// cada sílaba con su propio texto y su propia nota en el pentagrama (ej. "mu-cu-ra"
// dentro de un solo tiempo). Solo guarda datos; el Chart aún no dibuja cada sílaba
// por separado (muestra el texto unido) — eso queda para el Cambio 57.
(function () {
  "use strict";

  const STYLE_ID = "s936SuiteProStructureStylesV460Cambio56";
