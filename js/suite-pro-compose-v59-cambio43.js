// Studio 936 Composer - Suite Pro Compose Coordinator v5.9 Cambio 43
...
(function () {
  ...
  const STYLE_ID = "s936SuiteProComposeStylesCambio42";
...
`;
    ...
    style.textContent += `
/* Cambio 43 · Subnav estable sin romper escenario Chart: conserva Mapa Maestro y deja Tab Pro discreto si aún no tiene módulo real */
#s936SuitePro .s936-compose-subrail{
  max-width:100%!important;
  overflow-x:hidden!important;
}
...
`;
    ...
    style.textContent += `
/* Cambio 43 · Top menu estable y subnav sin invadir ni generar scroll horizontal */
html, body{
  overflow-x:hidden!important;
}
#s936SuitePro{
