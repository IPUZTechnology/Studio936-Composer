// Studio 936 Composer - Suite Pro Structure / ADN Module v4.4.8 Cambio 43
  ...
  function installDockFlexGuard() {
    ...
    const sync = () => {
      try {
        ...
        if (chartPanel) {
          // Cambio 43: no empujar el Chart con margin-left; eso generaba scroll horizontal
  ...
  function installChartStageKeeperCambio41() {
    ...
    const ensure = () => {
      try {
        ...
        console.warn("Cambio 43 chart keeper:", error);
      }
    };
...
`;
    ...
    style.textContent += `
/* Cambio 43 · Dock flexible real, sin cubrir Chart ni crear scroll horizontal */
html, body{
  overflow-x:hidden!important;
}
#s936SuitePro{
...
`;
    ...
    style.textContent += `
/* Cambio 43 · Zoom sección: consola ampliada de sesión */
...
`;
    ...
    style.textContent += `
/* Cambio 43 · Zoom sección sin controles repetidos: barra principal + herramientas */
...
`;
  ...
  function renderZoomSessionConsole(ctx, root, s, part, parts) {
    ...
    const status = ctx.el("div", "s936-zoom-session-status", "Usa la barra del canal para Play / Loop / Salir. Aquí preparas instrumentos, pads, REC y envío al Studio.");
    const panel = () => document.getElementById("s936-chart-view-panel");
    ...
    const toolsTitle = ctx.el("div", "s936-zoom-session-tools-title", "Herramientas de la sección");
    ...
    grid.append(
      ...
      toolButton("", "Ly Letra", "lírica por compás", "studio936:open-section-lyrics", "Letra por compás preparada para: " + label + ". Próximo módulo: Ly/Karaoke."),
  ...
  function partRow(ctx, s, parts, part, index) {
    ...
    // Cambio 43: en Zoom sección, la barra del canal solo deja los controles principales.
