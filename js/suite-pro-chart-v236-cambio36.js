// Studio 936 Composer - Chart View v2.3.6 Cambio 36 (CONSOLA POR SECCIÓN FUNCIONAL)
...
window.Studio936SuiteProChart = (() => {
  "use strict";
  const VERSION = "chart-v2.3.6-cambio-36";
...
/* Cambio 36 · Escenario más alto: Chart pegado a los controles superiores. */
body.s936-chart-stage .status-bar{
  min-height:30px!important;
