// Studio 936 Composer - Suite Pro Structure / ADN Module v4.8.3 Cambio 83
...
// Cambio 83: la altura del panel Ly Letra ya no se calcula "a mano" en JS
// (podía medirse antes de que el navegador terminara el layout, dejando un
// hueco vacío) — ahora usa height:auto + max-height en CSS, así el propio
// navegador ajusta el panel a su contenido real. Luego, con
// requestAnimationFrame, se mide el tamaño YA renderizado para anclar el
// panel al fondo de la ventana (los primeros compases del Chart quedan
// visibles arriba). El resize manual (arrastrar la esquina) sigue intacto.
(function () {
  "use strict";
  ...
  const MODULE_CAMBIO_LABEL = "Cambio 83";

  const STYLE_ID = "s936SuiteProStructureStylesV483Cambio83";
