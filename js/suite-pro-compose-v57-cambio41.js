// Studio 936 Composer - Suite Pro Compose Coordinator v5.7 Cambio 41
...
(function () {
  ...
  const STYLE_ID = "s936SuiteProComposeStylesCambio41";
...
`;
    ...
    style.textContent += `
/* Cambio 41 · Subnav estable sin romper escenario Chart: conserva Mapa Maestro y deja Tab Pro discreto si aún no tiene módulo real */
#s936SuitePro .s936-compose-subrail{
  max-width:100%!important;
  overflow-x:hidden!important;
}
...
`;
    ...
    style.textContent += `
/* Cambio 41 · Top menu estable y subnav sin invadir ni generar scroll horizontal */
html, body{
  overflow-x:hidden!important;
}
#s936SuitePro{
