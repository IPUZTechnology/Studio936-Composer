// Studio 936 Composer - Suite Pro Compose Coordinator v3.7 Cambio 24
...
(function () {
  ...
  const STYLE_ID = "s936SuiteProComposeStylesCambio24";
...
`;
  ...
  function render(ctx) {
    ...
    const banner = ctx.el("div", "s936-cmp-change-banner", "Cambio número 24 · Menú mini + compás sostenido limpio");
    ...
    try {
      ...
      box.innerHTML = "<b>Cambio número 24 · Estructura no pudo renderizar.</b><br>El error queda visible en pantalla. Revisa la primera línea roja de consola.";
