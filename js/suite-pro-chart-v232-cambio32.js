// Studio 936 Composer - Chart View v2.3.2 Cambio 32 (CONSOLA POR SECCIÓN FUNCIONAL)
...
window.Studio936SuiteProChart = (() => {
  "use strict";
  const VERSION = "chart-v2.3.2-cambio-32";
  const STYLE_ID = "s936-chart-v232-cambio32";
