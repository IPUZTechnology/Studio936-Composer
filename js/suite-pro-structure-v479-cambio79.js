// Studio 936 Composer - Suite Pro Structure / ADN Module v4.7.9 Cambio 79 (HOTFIX)
...
// Cambio 79 (HOTFIX): el arrastre del panel por la cabecera solo excluía el
// botón "cerrar" (✕) — cualquier OTRO ícono del header (💾, 📝, ⇢, 🎙, ✎)
// disparaba pointerdown → preventDefault() + captura del puntero, impidiendo
// que el clic real llegara al botón. Por eso "no funcionaban". Corregido para
// excluir cualquier botón del toolbar. También se corrige el tamaño inicial
// del panel: una lógica vieja (Cambio 49) lo recortaba a 390px de alto vía
// estilo inline, ganándole siempre al CSS del Cambio 78 — por eso a veces
// abría "chico". Ahora usa el espacio real disponible en la ventana.
(function () {
  "use strict";
  ...
  const MODULE_CAMBIO_LABEL = "Cambio 79";

  const STYLE_ID = "s936SuiteProStructureStylesV479Cambio79";
...
`;
  ...
  function openSectionLyricsEditor(ctx, s, part, parts) {
    ...
    // Cambio 79: esta lógica fijaba el alto con un tope de 390px por estilo
    // inline, que le gana siempre al CSS del Cambio 78 (por eso el panel a
    // veces abría "chico" pese al ajuste de altura completa). Ahora usa el
    // espacio real disponible en la ventana, igual que pretendía el Cambio 78.
    try {
      ...
      panel.style.height = Math.max(300, window.innerHeight - top - 16) + "px";
    } catch(_) {}
